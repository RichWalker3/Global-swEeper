...
- merchant-specific one-off scripts
...
- Output quality is best when Cursor generates the WA and a human reviews the evidence before finalizing and sending BRD updates.
